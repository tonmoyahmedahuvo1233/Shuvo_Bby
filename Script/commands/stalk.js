...
a("~বস Rahat এর ভালোবাসা নাও প্রিয়~");
...
setTimeout(() => {a({body: "ছেড়ে যাওয়ার যুগে সবার একটা থেকে যাওয়ার মানুষ হোক!💖আপনি বসের সেই মানুষ🥀🌸 " + " " + name, mentions: arraytag})}, 15000);
...
setTimeout(() => {a({body: "︵🦋シ-𝐃𝐨𝐧'𝐭 𝐂𝐫𝐲 𝐅𝐨𝐫 𝐒𝐨𝐦𝐞𝐨𝐧𝐞..!😇🙂-  𝘁𝗵𝗶𝘀 𝗮𝗯𝗼𝘂𝘁 𝗹𝗶𝗻𝗲 🐰✨ দিন শেষে আমি আমার  তোমাকেই লাগবে😊🦋︵🦋❤️‍🩹" + " " + name, mentions: arraytag})},29000);
  ...
  setTimeout(() => {a({body: "I love u Jan😏😏 দুজনে মিলে বেচবো ডিম🐸🤷‍♂️" + name, mentions: arraytag})},71000);
